import { View, Text,TouchableOpacity, Image, TouchableWithoutFeedback, Keyboard, KeyboardAvoidingView, Platform, TextInput } from 'react-native'
...
const SignUp = () => {
  ...
  const [request, response, promptAsync] = Google.useAuthRequest({
    clientId:"856764674333-uu5f6no67581v7ih668s3skrp7mf4qdm.apps.googleusercontent.com",
   ...
   <View
    ...
    >
        ...
        <View>
            ...
            >It only takes a minute to create </Text>
            <Text
            style={{
                fontFamily:'ReadexRegular',
                fontSize:14,
